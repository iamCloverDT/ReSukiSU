...
#define SULOG_BUFSIZ SULOG_ENTRY_MAX * (sizeof(struct tiny_sulog_entry))
...
void write_sulog(uint8_t sym)
{
    ...
    unsigned int offset = sulog_index_next * sizeof(struct tiny_sulog_entry);
    struct tiny_sulog_entry entry = { 0 };
